...
import CreateProfile from "./views/Hints";
import Destine from "./views/Destine";
...
function App(props) {
  ...
  const purpose = useContractReader(readContracts, "DKDating", "purpose", [], localProviderPollingTime);
